...
import { Students as StudentsType } from 'type/students.type'
...
export default function Students() {
  // const [students, setSudents] = useState<StudentsType>([])
  ...
  return (
    <div>
      ...
      <div>
        <Link type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4
         focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 " to='/students/add'>Add Student</Link>
